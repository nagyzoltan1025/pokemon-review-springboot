...
class ReviewRepositoryTests {
    ...
    @Test
    void ReviewRepository_GetAll_ReturnMoreThenOneReview() {
    ...
    void ReviewRepository_FindById_ReturnsSavedReview() {
        ...
        Review fetchedReview = reviewRepository.findById(review.getId()).get();

        Assertions.assertThat(fetchedReview).isNotNull();
    }
    ...
    void ReviewRepository_UpdateReview_ReturnReview() {
        ...
        reviewRepository.save(review);
        Review fetchedReview = reviewRepository.findById(review.getId()).get();
        fetchedReview.setTitle("new title");
        reviewRepository.save(fetchedReview);
        ...
        Assertions.assertThat(reviewList)
                .isNotNull()
                .hasSize(1);
        Assertions.assertThat(fetchedReview.getTitle()).isEqualTo("new title");
    }
